...
>
    <div class="w-full max-w-md mx-auto">
        ...
        <div
            class="min-h-screen md:min-h-0 bg-white md:rounded-3xl md:shadow-xl md:shadow-indigo-100/50 p-6 sm:p-8 md:border md:border-gray-100"
        >
            <!-- Logo inside card -->
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-sm text-gray-500">
                    Start managing your projects with Ticketly
                </p>
            </div>
            ...
            <!-- Email Form -->
            <form
                on:submit|preventDefault={handleEmailSignup}
                class="space-y-5"
            >
                <div>
                    <label
